...
#define TUNER_GPIO_NUM(GPIO_NUM)  GPIO_NUM_##GPIO_NUM

#define TUNER_SAMPLE_PERIOD_MS    10

#define TUNER_GND_PIN_X_AXIS      MACRO_EXPAND(TUNER_GPIO_NUM, BOAP_CONTROL_GND_PIN_X_AXIS_NUM)
#define TUNER_HIGH_Z_PIN_X_AXIS   MACRO_EXPAND(TUNER_GPIO_NUM, BOAP_CONTROL_HIGH_Z_PIN_X_AXIS_NUM)
